...
\KeywordTok{View}\NormalTok{(Auto_data)}
...
\KeywordTok{str}\NormalTok{(Auto_data)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{str}\NormalTok{(Auto_data}\OperatorTok{$}\NormalTok{horsepower)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#use only fields with numeric values}
...
\KeywordTok{print}\NormalTok{(}\StringTok{"ONLY the first 25 Auto_data_clust"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Clustering_student_Moosun_Brad_Kim_1_files/figure-latex/unnamed-chunk-8-1.pdf}
...
\includegraphics{Clustering_student_Moosun_Brad_Kim_1_files/figure-latex/unnamed-chunk-19-1.pdf}
...
\includegraphics{Clustering_student_Moosun_Brad_Kim_1_files/figure-latex/unnamed-chunk-21-1.pdf}
...
\includegraphics{Clustering_student_Moosun_Brad_Kim_1_files/figure-latex/unnamed-chunk-22-1.pdf}
...
\includegraphics{Clustering_student_Moosun_Brad_Kim_1_files/figure-latex/unnamed-chunk-24-1.pdf}
...
\includegraphics{Clustering_student_Moosun_Brad_Kim_1_files/figure-latex/unnamed-chunk-26-1.pdf}
...
\includegraphics{Clustering_student_Moosun_Brad_Kim_1_files/figure-latex/unnamed-chunk-28-1.pdf}
...
\includegraphics{Clustering_student_Moosun_Brad_Kim_1_files/figure-latex/unnamed-chunk-29-1.pdf}
...
\includegraphics{Clustering_student_Moosun_Brad_Kim_1_files/figure-latex/unnamed-chunk-29-2.pdf}
\newpage
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# load the crab data}
\KeywordTok{library}\NormalTok{(ggplot2)}
\KeywordTok{library}\NormalTok{(MASS)}
\KeywordTok{data}\NormalTok{(crabs)}
\NormalTok{crabs <-}\StringTok{ }\KeywordTok{within}\NormalTok{(crabs,\{}
  \KeywordTok{levels}\NormalTok{(sp)  <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{'Blue'}\NormalTok{,}\StringTok{'Orange'}\NormalTok{)}
  \KeywordTok{levels}\NormalTok{(sex) <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{'Female'}\NormalTok{,}\StringTok{'Male'}\NormalTok{)}
\NormalTok{\})}


\CommentTok{# Perform PCA on the data}
\CommentTok{# retx returns the scores for each crab}
\CommentTok{# Append the components for each crab to the original data}
\NormalTok{crab.pca <-}\StringTok{ }\KeywordTok{prcomp}\NormalTok{(crabs[,}\DecValTok{4}\OperatorTok{:}\DecValTok{8}\NormalTok{],}\DataTypeTok{retx=}\OtherTok{TRUE}\NormalTok{)}
\NormalTok{crabs}\OperatorTok{$}\NormalTok{PC1 <-}\StringTok{ }\NormalTok{crab.pca}\OperatorTok{$}\NormalTok{x[,}\DecValTok{1}\NormalTok{]}
\NormalTok{crabs}\OperatorTok{$}\NormalTok{PC2 <-}\StringTok{ }\NormalTok{crab.pca}\OperatorTok{$}\NormalTok{x[,}\DecValTok{2}\NormalTok{]}
\NormalTok{crabs}\OperatorTok{$}\NormalTok{PC3 <-}\StringTok{ }\NormalTok{crab.pca}\OperatorTok{$}\NormalTok{x[,}\DecValTok{3}\NormalTok{]}

\CommentTok{# Print the rounded scores for the first three components}
\KeywordTok{write.table}\NormalTok{(}\KeywordTok{signif}\NormalTok{(crab.pca}\OperatorTok{$}\NormalTok{rotation[,}\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{],}\DecValTok{3}\NormalTok{),}\StringTok{"rotations.tab"}\NormalTok{)}

\CommentTok{#}
\CommentTok{# Plot discrimating factors found in the second component}
\CommentTok{#}
\NormalTok{second_component_dotplot <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(crabs, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ CW, }\DataTypeTok{x =}\NormalTok{ RW))        }\OperatorTok{+}
\StringTok{        }\KeywordTok{geom_point}\NormalTok{()                              }\OperatorTok{+}
\StringTok{        }\KeywordTok{scale_x_continuous}\NormalTok{(}\StringTok{"Rear width (mm)"}\NormalTok{)     }\OperatorTok{+}
\StringTok{        }\KeywordTok{scale_y_continuous}\NormalTok{(}\StringTok{"Carapace width (mm)"}\NormalTok{)}

\KeywordTok{png}\NormalTok{(}\StringTok{"second_component_dotplot.png"}\NormalTok{); }\KeywordTok{print}\NormalTok{(second_component_dotplot)}
